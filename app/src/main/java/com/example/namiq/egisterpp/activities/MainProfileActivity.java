...
public class MainProfileActivity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.edit) {
            ...
            if (!editStatus) {
                editMenu.setIcon(R.drawable.save_menu);
                userDescription.setVisibility(View.GONE);
                editDesc.setVisibility(View.VISIBLE);
                editStatus = true;
            } else {
                editMenu.setIcon(R.drawable.edit_button);
                saveDescription();
                Intent i = getIntent();
    ...
    public void saveDescription() {
        ...
        FirebaseDatabase.getInstance().getReference().child("users").child(email).child("description").setValue(description);
        editDesc.setText("");
    }
